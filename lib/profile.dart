                              ...
                              Expanded( // Ensure the text column doesn't overflow
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        _nameController.text.isNotEmpty ? _nameController.text : 'Name not available',
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 20,
                                        ),
                                      ...
                                      Text(
                                        _phoneController.text.isNotEmpty ? '+91 ${_phoneController.text}' : 'Phone not available',
                                      ),
                                      Text(
                                        _emailController.text.isNotEmpty ? _emailController.text : 'Email not available',
                                      ),
                                      Text(
                                        _addressController.text.isNotEmpty ? _addressController.text : 'Address not available',
                                      ),
                                    ],
                                  ),
                                ),
